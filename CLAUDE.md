...
**YOU ARE IN: `go_pi/polecats/amethyst/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/go_pi/` (rig root) or other directories
...
**Your mail address:** `go_pi/polecats/amethyst`
**Your rig:** go_pi
**Your Witness:** `go_pi/witness`
...
| Ask Witness for help | `gt mail send go_pi/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`go_pi/witness`) when:
...
```bash
gt mail send go_pi/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
